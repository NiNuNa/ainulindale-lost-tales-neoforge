...
public class LostTalesHostileMapIconProvider implements LostTalesCompassHud.IconProvider {
    ...
    public List<LostTalesCompassHud.MapIcon> collect(Minecraft mc) {
        ...
        List<LostTalesCompassHud.MapIcon> out = new ArrayList<>(list.size());
        for (Entity e : list) {
            ...
            LostTalesCompassHud.MapIcon icon = new LostTalesCompassHud.MapIcon(
